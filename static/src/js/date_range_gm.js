...
//                $('.result-date-statistic').html(start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD'))
        ...
        _onApplyData(){
           ...
           let flagArr = [{
                ...
                domain: `[['request_date','>=','${startDate.format('YYYY-MM-DD')} 00:00:00'],['request_date','<=','${endDate.format('YYYY-MM-DD')} 23:59:59']]`,
                type: 'filter',
            }]
    ...
    DateRangeGM.template = 'multi_level_approval.DateRangeGM';

    return { Component: DateRangeGM };
});
